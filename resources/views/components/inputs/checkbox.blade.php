...
@foreach ($choices as $value => $choice)
    <div class="flex items-center mb-2 ms-2">
        <input @if ($required) required @endif id="{{ $name . '-' . $value }}" type="radio"
            ...
            {{ old($name,$chosen) == ($choice === true ? '1' : ($choice === false ? '0' : $choice)) ? 'checked' : '' }}>
